...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-background py-20">
      <SeoHead
        title="Privacy Policy | CRM Launch UK"
        description="Understand how CRM Launch collects, stores, and protects your business data. Built for GDPR compliance and UK small businesses."
